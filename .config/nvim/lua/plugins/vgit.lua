return {
    ...
    keys = {
        ...
        { mode = "n", "<leader>gac", function() require("vgit").buffer_conflict_accept_current() end,  desc = "Accept current change" },
        { mode = "n", "<leader>gai", function() require("vgit").buffer_conflict_accept_incoming() end, desc = "Accept incoming change" },
        { mode = "n", "<leader>gab", function() require("vgit").buffer_conflict_accept_both() end,     desc = "Accept both changes" },
